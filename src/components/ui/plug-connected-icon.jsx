...
const PlugConnectedIcon = forwardRef((
  ...
  const stop = useCallback(async () => {
    animate(".plug-upper-part, .plug-lower-leg, .plug-lower-part", {
      y: 0,
      x: 0,
      opacity: 1,
    }, {
